        ...
        >
                            ...
                            <div className="bg-gray-50 rounded-lg overflow-hidden border border-gray-200 hover:border-primary-300 transition-all duration-200 h-full flex flex-col">
                                ...
                                <div className="p-5 flex-grow">
                                    ...
                                    justify-between">
                                        ...
                                        <div className="flex items-center bg-primary-50
                                         text-primary-800 px-2 py-1 rounded text-sm font-medium">
            ...
            <div className="px-6 pb-6 text-center">
                <Link 
                    ...
                    hover:text-pink-800 font-medium font-mono transition-colors"
                >
